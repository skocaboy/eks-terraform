...
module "eks" {
  ...
  cluster_role_arn = "arn:aws:iam::123456789012:role/EKS_ClusterRole_Staging"
  node_group_name  = "staging-node-group"
  node_role_arn    = "arn:aws:iam::123456789012:role/EKS_NodeRole_Staging"
...
module "cloudwatch" {
  ...
  rds_identifier  = "staging-rds-mysql"
  environment     = "staging"
